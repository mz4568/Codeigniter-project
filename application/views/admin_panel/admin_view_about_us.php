  ...
  <div class="container-fluid">
    ...
    <div class="container">
        ...
        <div class="alert alert-success">
           ...
           <h2><?php echo $view_about_us->title;?></h2>
           <p><?php echo $view_about_us->content;?></p>
         
          <p><a class="btn btn-default" href="<?php echo base_url();?>admin_controller/edit_data/<?php echo $view_about_us->about_us_id;?>" role="button">Edit</a></p>
